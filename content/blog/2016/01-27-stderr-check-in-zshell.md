...
![stderr]({static}/img/2016/01-27/shell_error.png)
...
![ex1_1]({static}/img/2016/01-27/ex1_1.png)
...
![ex1_2]({static}/img/2016/01-27/ex1_2.png)
...
![ex2_1]({static}/img/2016/01-27/ex2_1.png)
...
![ex2_2]({static}/img/2016/01-27/ex2_2.png)
...
In: check_rbenv = sub.Popen(
    'which rbenv', stdout=sub.PIPE, stderr=sub.PIPE, shell=True
).communicate()
